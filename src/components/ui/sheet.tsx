    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=bottom]:inset-x-0 data-[side=bottom]:bottom-0 data-[side=bottom]:h-[85dvh] data-[side=bottom]:max-h-[90dvh] data-[side=bottom]:border-t data-[side=bottom]:rounded-t-[1.75rem]",
          "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:w-full data-[side=left]:border-r sm:data-[side=left]:w-auto",
          "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:w-full data-[side=right]:border-l sm:data-[side=right]:w-auto",
      ...
      >
        {side === "bottom" && (
          <div className="absolute left-1/2 top-2.5 -translate-x-1/2 h-1.5 w-12 rounded-full bg-muted-foreground/30 shrink-0" aria-hidden="true" />
        )}
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button variant="ghost" className="absolute top-3 right-3 z-10" size="sm">
              <XIcon />
