          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {filtered.map((ex, idx) => {
              ...
              return (
                <article
                  key={ex.name}
                  className={`group h-full flex-col overflow-hidden rounded-[22px] border border-white/10 bg-card/95 shadow-[0_18px_50px_-35px_rgba(0,0,0,0.45)] transition-all duration-300 hover:-translate-y-1 hover:border-border/40 hover:shadow-[0_30px_80px_-45px_rgba(0,0,0,0.55)] ${idx >= 2 ? 'hidden sm:flex' : 'flex'}`}
                >
