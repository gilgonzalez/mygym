...
import { Plus, Trash2, GripVertical, Save,  ArrowLeft, Eye, Play, Smartphone, Monitor, Image as ImageIcon,  Music, X, Upload, Mic, Square, Camera, Circle, Dna, Activity, Repeat, RotateCw, Library, Package, Globe, Lock, FileText, Sparkles, Loader2, Info, Timer, Zap, List, BedDouble, Users } from 'lucide-react'
import { 
  Select,
  SelectContent,
  SelectItem,
                              ...
                              <div className="mt-3 space-y-3 sm:mt-6 sm:space-y-5">
                                ...
                                <div className="space-y-5">
                                  <div className="rounded-[20px] border border-border/60 bg-background/75 p-3 shadow-sm sm:rounded-[28px] sm:p-3 lg:p-3.5">
                                    ...
                                    <div className="mt-2 space-y-2 sm:mt-2.5 sm:space-y-2.5 lg:grid lg:grid-cols-[0.68fr_repeat(3,minmax(0,1fr))] lg:items-stretch lg:gap-1.5 lg:space-y-0">
                                      <Controller
                                        control={control}
